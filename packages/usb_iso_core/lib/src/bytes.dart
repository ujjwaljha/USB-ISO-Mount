...
/// FAT32 EFI System Partition for multiboot USBs (GRUB only).
const int efiSystemPartitionMiB = 512;
const int efiSystemPartitionBytes = efiSystemPartitionMiB * 1024 * 1024;

/// Volume labels for the multiboot GPT layout.
const String efiBootVolumeLabel = 'EFIBOOT';
const String isoBootVolumeLabel = 'ISOBOOT';

/// Folder on the exFAT data volume that holds Linux live ISOs.
const String multibootIsoFolder = 'isos';
